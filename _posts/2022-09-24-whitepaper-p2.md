...
<center>*The Gaussian weight distribution with parameter $\mu=-0.5$ and $\sigma=0.1$; Image generated by the author. Vertical axis displays the probability of obtaining W in horizontal axis.* </center>
...
Now before we can decide what parameters are the best for the weight distribution, we are going to build our intuition on the behavior of this ANN. In the following we are going assume that the input of the network is $
