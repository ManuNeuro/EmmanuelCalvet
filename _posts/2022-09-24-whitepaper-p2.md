...
![]({{ '/assets/article_images/2022-09-24-whitepaper-p2/normal_weight.png' | relative_url }})
...
Now before we can decide what parameters are the better for the weight distribution, we are going to build our intuition on what would be desirable.

So let's assume that all of our weights are inhibitory, which means negative, exactly like the weight distribution displayed above. 
